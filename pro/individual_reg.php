...
<div class="signup-page">
    <div class="form">
        ...
        <form class="login-form" method="post" role="form" enctype="multipart/form-data" id="signup-form"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label>Contact Number eg. +233 548342821</label>
                    <input type="text" required name="phone" pattern="^[\W][0-9]{3}?[\s]?[0-9]{2}?[\s]?[0-9]{3}[\s]?[0-9]{4}$">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label>Email Address</label>
                    <input type="email" required name="email" pattern="\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$">
                </div>
            </div>
