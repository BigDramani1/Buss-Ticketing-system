...
if (isset($_GET['status'], $_GET['id'])) {
    ...
    echo "<script>window.location='admin.php$me';</script>";
}
?>
                                        ...
                                        while ($fetch = $row->fetch_assoc()) {
                                            ...
                                            <td>
                                                ...
                                                <a href="admin.php?page=users&status=1&id=<?php echo $id; ?>">
                                                    <button
                                                        onclick="alert('You are about allowing this user be able to login his/her account.')"
                                                ...
                                                <a href="admin.php?page=users&status=0&id=<?php echo $id; ?>">
                                                    <button
                                                        onclick="alert('You are about denying this user access to  his/her account.')"
