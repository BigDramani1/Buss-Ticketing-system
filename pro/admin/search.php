...
<div class="content">
    ...
    <section class="content">
        ...
        <tr><th>Train</th><td>" . getTrainName($row['bus_id']) . "</td></tr>
        </table>";
                                }
                            }
