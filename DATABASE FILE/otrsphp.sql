...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2022 at 12:26 AM
...
drop database if exists otrsphp;
CREATE database otrsphp;
use otrsphp;
-- --------------------------------------------------------
...
(31, 102, 40, 7, '2021/0102/1502', 'first', 1, 'F001', 'Wed, 13-Oct-2022 06:18:10 AM'),
...
(12, 9, 'Need to reduce your prices', NULL),
(13, 9, 'We need snacks on the buses', NULL);
...
(9, 'Osimpo Amo', 'osimpo@yahoo.com', '9137923bcc50d31d41364dd0c91f8e4b', '78965423100', 'Nii Street', '7d1bc5d857251a0ec802563f0ab06a0a.jpg', 1);
...
(4, 'Accra', 'Kumasi'),
(5, 'Accra', 'Sunyani'),
(6, 'BrongAhafo', 'CapeCoast'),
(7, 'Tamale', 'Accra'),
(8, 'Wa', 'Tamale'),
(9, 'Cape Coast  ', 'Accra'),
(10, 'Cape Coast', 'Takoradi'),
(11, 'Takoradi ', 'Accra'),
(12, 'Accra', 'Winneba'),
(13, 'Ho', 'Bolgatanga'),
(14, 'Kwahu', 'Accra'),
(15, 'Aburi', 'Akosombo'),
(16, 'Akosombo', 'Keta'),
(17, 'Accra', 'Afram Plains'),
(18, 'Konongo', 'Accra Central'),
(19, 'Winneba', 'Aburi');
...
(101, 2, 10, '12-10-2022', '22:59', 105, 55),
...
(1, 'Kano Rails', 30, 50),
(2, 'British Railways', 20, 60),
(3, 'Wester Railways', 10, 40),
(7, 'Lagos Rails', 30, 50),
(8, 'Marble Railways', 12, 45),
(9, 'Renfee R', 20, 40),
(10, 'Venice Express', 15, 50),
(11, 'Orient Express', 20, 50),
(12, 'Phantom Express', 25, 49),
(13, 'Marshland Express', 12, 35);
