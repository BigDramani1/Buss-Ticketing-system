                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title"><span class="main-element themecolor"
                                    data-elements=" Bussdown, Bussdown,Bussdown"></span></h1>

                            <h1 class="main-heading-title"><span class="main-element themecolor"
                                    data-elements=" Express, Express, Express"></span>
                            </h1>

                            <p class="main-heading-text">AN ONLINE BUS<br />TICKETING AND PAYMENT SYSTEM</p>
